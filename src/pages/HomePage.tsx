...
import { Search, ArrowRight, MapPin, Shield, Star, Zap } from "lucide-react";
    ...
    <div className="min-h-screen pt-16 pb-20 md:pb-0">
        ...
        <div className="container py-16 md:py-24">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                to="/listings"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg gradient-primary text-primary-foreground font-semibold shadow-glow hover:opacity-90 transition-opacity"
              >
              ...
              <Link
                to="/signup"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-card border border-border text-foreground font-semibold hover:bg-secondary transition-colors"
              >
                Get Started
      ...
      <section className="container py-8 pb-16">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="font-display text-2xl font-bold text-foreground">Top Rated PGs</h2>
            <p className="text-sm text-muted-foreground">Highest rated by verified residents</p>
          </div>
      ...
      <section className="container pb-16">
        <div className="gradient-primary rounded-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-primary-foreground/80 mb-6 max-w-md mx-auto">
            List your property, manage bookings, and reach thousands of students looking for accommodation.
          </p>
          <Link
            to="/signup"
